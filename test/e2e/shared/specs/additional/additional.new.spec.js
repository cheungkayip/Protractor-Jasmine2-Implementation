...
module.exports = function(TestData) {
	...
	it('selects passengerInuries coverage', () => {
		...
		expect(additionalPanel.passengerInjuries.checkbox.isDisabled()).toBeFalsy();
	...
	it('selects noClaim coverage', () => {
		...
		expect(additionalPanel.noClaim.checkbox.isDisabled()).toBeFalsy();
	...
	it('selects roadAssistanceNetherlands coverage', () => {
		Aiepe2etools.general.scrollIntoView(additionalPanel.roadAssistanceNetherlands.header);
	...
	it('selects roadAssistanceAbroad coverage', () => {
		Aiepe2etools.general.scrollIntoView(additionalPanel.roadAssistanceAbroad.header);
